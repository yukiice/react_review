...
import { addAction, subAction, addNullAction,getHomeMultiDataAction } from "../flow/actionCreators";
class SplitDemo4 extends PureComponent {
    componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(SplitDemo4);
